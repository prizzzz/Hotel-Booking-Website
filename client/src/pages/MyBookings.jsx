                ...
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                    <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                            ...
                            <p className='test-base'>Total: ${booking.totalPrice}</p>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col items-start justify-center pt-3'>
                        <div className='flex items-center gap-2'>
                            ...
                            <div className={`text-sm ${booking.isPaid ? "text-green-500" : "text-red-500"}`}>{booking.isPaid ? "Paid" : "Unpaid"}</div>
                        </div>
                        {!booking.isPaid && (
                            <button className='px-4 py-1.5 mt-4 text-xs border borser-gray-400 rounded-full hover:bg-gray-50 transition-all cursor-pointer'>Pay Now</button>
                        )}
